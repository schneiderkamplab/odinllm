...
from .utils import chars_token_ratio, end, get_prepare_sample_text, parse_args, trainable_parameters, start, status
...
def get_training_args(output_dir, max_steps, per_device_train_batch_size, gradient_accumulation_steps):
    training_arguments = TrainingArguments(
        ...
        run_name=f"sft_{output_dir}",
        report_to="wandb",
    )
    return training_arguments    

def train(trainer, output_dir):
